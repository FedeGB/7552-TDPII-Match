...
public class MatchActivity extends AppCompatActivity implements HttpResponseListener {
    ...
    private void getMatchActivityData() {
    ...
    public void httpRequestError(HttpConnection connection) {
        ...
        dlgAlert.setMessage("Se perdió la conexion con el servidor, intente mas tarde");
        dlgAlert.setTitle("Conexión perdida");
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.tallerii.match/http/host/path")
        );
